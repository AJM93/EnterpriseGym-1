        ...
        <div id="QuizRegister" class="bs-example">
            <form method="POST"  action="CreateQuizQuestions">
                ...
                <div class="form-group"  id="Q3">
                    ...
                    <input type="text" class="form-control" id="inputCorrect3" name="Correct3" required placeholder="Please enter the NUMBER of the CORRECT ANSWER">
                </div>
                ...
                <div class="form-group" id="Q4">
                    ...
                    <input type="text" class="form-control" id="inputCorrect4" name="Correct4" required placeholder="Please enter the NUMBER of the CORRECT ANSWER">
                </div>
                ...
                <div class="form-group" id="Q5">
                    ...
                    <input type="text" class="form-control" id="inputCorrect5" name="Correct5" required placeholder="Please enter the NUMBER of the CORRECT ANSWER">
                </div>    
                ...
                <div class="form-group" id="Q6">
                    ...
                    <input type="text" class="form-control" id="inputCorrect6" name="Correct6" required placeholder="Please enter the NUMBER of the CORRECT ANSWER">
                </div>
                ...
                <div class="form-group" id="Q7">
                    ...
                    <input type="text" class="form-control" id="inputCorrect7" name="Correct7" required placeholder="Please enter the NUMBER of the CORRECT ANSWER">
                </div>
                ...
                <div class="form-group" id="Q8">
                    ...
                    <input type="text" class="form-control" id="inputCorrect8" name="Correct8" required placeholder="Please enter the NUMBER of the CORRECT ANSWER">
                </div>
                ...
                <div class="form-group" id="Q9">
                    ...
                    <input type="text" class="form-control" id="inputCorrect9" name="Correct9" required placeholder="Please enter the NUMBER of the CORRECT ANSWER">
                </div>
                ...
                <div class="form-group" id="Q10">
                    ...
                    <input type="text" class="form-control" id="inputCorrect10" name="Correct10" required placeholder="Please enter the NUMBER of the CORRECT ANSWER">
                </div>
