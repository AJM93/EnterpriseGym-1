<%-- 
    Document   : index.jsp
    Created on : 21-Sep-2015, 10:10:26
    Author     : dan
--%>
        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="#page-top">The Enterprise Gym</a>
                </div>
        ...
        <header>
            <div class="header-content">
                <div class="header-content-inner">
                    <h1>The Enterprise Gym</h1>
                    <hr>
                    <p>Exercising Business Creativity</p>
