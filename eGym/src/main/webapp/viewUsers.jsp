    ...
    <div class="col-md-12">
        ...
        <table class="table" >
            ...
            <tr>
                ...
                <td><form action="resetUserPassword" method="POST"><button type="button" class="btn btn-default" name="getPasswordUsername" value=<%=Username%>>Reset Password</button></form></td>
                <td><form action="DeleteUserAccount" method="POST"><button type="button" class="btn btn-default" name="getDeletedUser" value=<%=Username%>>Delete Account</button></form></td>
            </tr>
            <%
                }
            %>
